 ...
 */
@WebServlet("/RegistrarWiki")
public class RegistrarWiki extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public RegistrarWiki() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if (autor!=null){
				...
				request.setAttribute("mensaje", "verifico correctamente  </br>Reporte de Datos del Autor </br></br> Titulo de la WIKI : "+tituloblog+"</br> Direccion WIKI : "+direccionblog+"</br> Nombres del Autor : "+ nombres +"</br> Apellidos  del Autor : "+ apellidopate+" "+apellidomate+"</br> Fecha de creacion : "+hoy+ "</br> Correo Electronico : "+correo);
